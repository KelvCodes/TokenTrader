    ...
    function getReserves() public view returns (uint112 _reserve0, uint112 _reserve1, uint32 _blockTimestampLast) {
        _reservea.length == 0 || abi.decode(data, (bool))), 'UniswapV2: TRANSFER_FAILED');
    }
    ...
    // Mint liquidity tokens to `to` based on deposited tokens
    ...
    // Perform a token swap with invariant checks and optional flash call
    ...
    // Send excess tokens (non-reserve) to `to`
    ...
    // Force sync reserves with actual balances
